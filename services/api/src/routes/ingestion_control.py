...
def _to_status_response(record: BoundedLogicalRunStatusRecord) -> BoundedLogicalRunStatus:
    return BoundedLogicalRunStatus(
        ...
        reserved_usage=BoundedLogicalRunUsage(
            records=record.reserved_usage.records,
            source_requests=record.reserved_usage.source_requests,
            pages=record.reserved_usage.pages,
            bytes_read=record.reserved_usage.bytes_read,
            extraction_calls=record.reserved_usage.extraction_calls,
        ),
        ...
        retry_oldest_at=record.retry_oldest_at,
