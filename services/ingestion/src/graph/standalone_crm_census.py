...
class StandaloneCrmCensusRepository:
    ...
    def status(self, census_id: str) -> dict[str, object] | None:
        ...
        return {
            ...
            "terminal_total_calls": record["terminal_total_calls"],
            "terminal_rows_processed": record["terminal_rows_processed"],
            "terminal_rows_skipped": record["terminal_rows_skipped"],
            "terminal_rows_failed": record["terminal_rows_failed"],
            "terminal_no_work_units": record["terminal_no_work_units"],
