...
MATCH (checkpoint:IngestionCheckpoint {checkpoint_key: $checkpoint_key})
...
MERGE (checkpoint:IngestionCheckpoint {checkpoint_key: $checkpoint_key})
...
OPTIONAL MATCH (deleting_run:IngestRun)
WHERE $ingest_run_id IS NOT NULL
