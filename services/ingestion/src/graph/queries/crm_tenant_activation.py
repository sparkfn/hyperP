...
SET candidate.state = 'active', candidate.activated_at = activated_at,
  ...
  release.activation_prior_mapping_head_id = CASE WHEN $mapping_head_present THEN $expected_mapping_head_id ELSE NULL END,
  release.activation_prior_mapping_revision_id = CASE WHEN $mapping_head_present THEN $expected_mapping_revision_id ELSE NULL END,
  release.activation_prior_mapping_revision_number = CASE WHEN $mapping_head_present THEN $expected_mapping_revision_number ELSE NULL END,
  release.activation_prior_mapping_manifest_digest = CASE WHEN $mapping_head_present THEN $expected_mapping_manifest_digest ELSE NULL END,
