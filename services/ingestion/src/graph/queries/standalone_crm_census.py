...
RETURN census.census_id AS census_id,
       ...
       census.terminal_total_calls AS terminal_total_calls,
       census.terminal_rows_processed AS terminal_rows_processed,
       census.terminal_rows_skipped AS terminal_rows_skipped,
       census.terminal_rows_failed AS terminal_rows_failed,
       census.terminal_no_work_units AS terminal_no_work_units,
