...
MATCH (authorization:CrmDealRepairRollbackAuthorization {run_id: $run_id, unit_id: $unit_id,
  ...
  authorization_token: $authorization_token, predecessor_transition_id: $predecessor_transition_id,
...
CREATE (disposition:CrmDealRepairSecondaryDisposition {run_id: $run_id, unit_id: $unit_id,
  ...
  authorization_reference: $authorization_reference, authorization_token: $authorization_token,
