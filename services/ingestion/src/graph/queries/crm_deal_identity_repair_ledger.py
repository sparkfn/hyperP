...
CREATE_CRM_DEAL_REPAIR_LEDGER_SCHEMA: tuple[str, ...] = (
    ...
    "CREATE INDEX crm_deal_repair_fence_unit IF NOT EXISTS FOR (n:CrmDealRepairFence) ON (n.run_id, n.unit_id)",
    "CREATE INDEX crm_deal_repair_rollback_receipt_unit IF NOT EXISTS FOR (n:CrmDealRepairRollbackReceipt) ON (n.run_id, n.unit_id)",
    "CREATE INDEX crm_deal_repair_mutation_unit IF NOT EXISTS FOR (n:CrmDealRepairMutationResult) ON (n.run_id, n.unit_id)",
    "CREATE INDEX crm_deal_repair_rollback_image_unit IF NOT EXISTS FOR (n:CrmDealRepairRollbackImage) ON (n.run_id, n.unit_id)",
    "CREATE INDEX crm_deal_repair_rollback_authorization_unit IF NOT EXISTS FOR (n:CrmDealRepairRollbackAuthorization) ON (n.run_id, n.unit_id)",
    "CREATE INDEX crm_deal_repair_verification_unit IF NOT EXISTS FOR (n:CrmDealRepairVerification) ON (n.run_id, n.unit_id)",
